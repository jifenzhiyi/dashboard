      ...
      <div class="list">
        ...
        <div :class ="{ 'animate-up': animateUp }">
          <div
            ...
            <span class="td t8">{{ item.spec }}</span>
    ...
    .tr {
      ...
      span {
        ...
        &.td {
          ...
          &.t3 { width: 90px; }
          &.t4, &.t6 { width: 60px; }
          &.t5 { width: 80px; color: #f00; }
          &.t7, &.t8 { width: 105px; }
          &.tup { width: 90px; color: #f00; }
          &.tdown { width: 90px; color: lawngreen; }
          &.t9 { flex: 1; }
        }
      }
    }
